    ...
    <div class="row">
        <div class="col-md-10 mx-auto">
            <div class="contact-form">
                ...
                ?>    
                <form action="http://jarang.com/php/function/update-penerima.php?id=<?= $id; ?>" method="post">            
                    ...
                    <div class="form-group">
                        ...
                        <input name="alamat" type="text" class="form-control" id="inputSubject" value="<?= $alamat; ?>" required>
                    </div>
                    <div class="form-group">
                        <label for="inputSubject">No Hp</label>
                        <input name="hp" type="text" class="form-control" id="inputSubject" value="<?= $hp; ?>" required>
                    </div>
